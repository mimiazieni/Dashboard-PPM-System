...
if(isset($_POST['search'])){
	...
	$searchq1 = $_POST['search1'];
	$searchq2 = $_POST['search2'];
	$sql2 ="SELECT  WorkWeek,InternalName, ExternalName, sum(QtyDefect) as count ,LotNo,Phase,Machine, Package FROM dbo.ERAView WHERE Year like '$searchq' AND WorkWeek BETWEEN '$searchq1' AND '$searchq2' and QtyDefect > 0 and ExternalName is not null group by WorkWeek,LotNo,InternalName,ExternalName,Phase,Machine, Package order by WorkWeek";
