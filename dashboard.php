...
//utk weekly buang AND Day = '$currentDay'
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">overview Daily</h2>
                                </div>
                            </div>
                        </div>
                                           ...
                                           <!-- <div class="icon">
                                            ...
                                            <div class="text">
                                             <center> <h2 class=""><font color="white"><U>OQA VM</U></font></h2></center>
                                              <!--besarkn font # -->
						<h2 class="text-center"><strong><a href="db_oqavm.php"><font color="GREEN"><?php echo(float) $row1['RESULT1']."<br />" ;?></font></a></strong></h2>
						<h2 class="text-center"><strong><a href="db_oqavmfailed.php"><font color="RED"><?php echo (float) $row1['RESULT11']."<br />" ;?></font></a></strong></h2>
                                          </div>
                                        </div>
                                    ...
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                          <!--  <div class="icon">
                                            ...
                                            <div class="text">
                                             <center> <h2 class="text-center"><font color="white"><U>FRONT END</U></font></h2></center>
                                              <!--besarkn font # -->
						<h2 class="text-center"><strong><a href="db_frontend.php"><font color="GREEN"><?php echo (float) $row1['RESULT2']."<br />" ;?></font></a></strong></h2>
						<h2 class="text-center"><strong><a href="db_frontendfailed.php"><font color="RED"><?php echo (float) $row1['RESULT22']."<br />" ;?></font></a></strong></h2>
                                          </div>
                                        </div>
                                        <div class="overview-chart">
                                ...
                                <div class="overview-item overview-item--c2">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                           ...
                                           <div class="text">
                                             <center> <h2 class="text-center"><font color="white"><U>   ERA  </U></font></h2></center>
                                              <!--besarkn font # -->
						<h2 class="text-center"><strong><a href="db_era.php"><font color="GREEN"><?php echo (float) $row1['RESULT3']."<br />" ;?></font></a></strong></h2>
						<h2 class="text-center"><strong><a href="db_erafailed.php"><font color="RED"><?php echo (float) $row1['RESULT33']."<br />" ;?></font></a></strong></h2>
                                          </div>
                                        </div>
                                        <div class="overview-chart">
                                           ...
                                           <!-- <div class="icon">
                                            ...
                                            <div class="text">
                                             <center> <h2 class=""><font color="white"><U>BE X-RAY</U></font></h2></center>
                                              <!--besarkn font # -->
						<h2 class="text-center"><strong><a href="db_bexray.php"><font color="GREEN"><?php echo(float) $row1['RESULT4']."<br />" ;?></font></a></strong></h2>
						<h2 class="text-center"><strong><a href="db_bexrayfailed.php"><font color="RED"><?php echo (float) $row1['RESULT44']."<br />" ;?></font></a></strong></h2>
                                          </div>
                                        </div>
                                        <div class="overview-chart">
...
$sql ="select (select count(*) 
from dbo.OQAVMView 
WHERE WorkWeek = '$workWeek' AND Year = $currentYear  AND [Defect Mode] is null )AS RESULT1,
(select count(*) 
from dbo.OQAVMView 
WHERE WorkWeek = '$workWeek' AND Year = $currentYear  AND [Defect Mode] is not null )AS RESULT11,
(select count(*) 
from dbo.FrontEndView 
WHERE WorkWeek = '$workWeek' AND Year = $currentYear  AND [Defect Mode] is null )AS RESULT2,
(select count(*) 
from dbo.FrontEndView  
WHERE WorkWeek = '$workWeek' AND Year = $currentYear  AND [Defect Mode] is not null)AS RESULT22,
(select count(*) 
from dbo.ERAView  
WHERE WorkWeek = '$workWeek' AND Year = $currentYear  AND InternalName is null AND ExternalName is null)AS RESULT3,
((select count(*) 
from dbo.ERAView  
WHERE WorkWeek = '$workWeek' AND Year = $currentYear  AND InternalName IS NOT NULL) +
(select count(*) 
from dbo.ERAView  
WHERE WorkWeek = '$workWeek' AND Year = $currentYear  AND ExternalName IS NOT NULL )) as RESULT33,
(select count(*) 
from dbo.BEXRAYView  
WHERE WorkWeek = '$workWeek' AND Year = $currentYear  AND [Defect Mode] is null )AS RESULT4,
(select isnull(count(*),0)
from dbo.BEXRAYView  
WHERE WorkWeek = '$workWeek' AND Year = $currentYear  AND [Defect Mode] IS NOT NULL )AS RESULT44";
...
while( $row1 = sqlsrv_fetch_array( $stmt, SQLSRV_FETCH_ASSOC) ) {
?>
<?php $sql1 ="select CreatedDate
from dbo.ERAView where WorkWeek='WW01' AND Year='2019'";
...
while( $row11 = sqlsrv_fetch_array( $stmt, SQLSRV_FETCH_ASSOC) ) {
echo (float) $row11['CreatedDate']."<br />" ;?>
