...
<body class="animsition">
 ...
 <div class="main-content">
                <div class="section__content section__content--p30"> 
<form name="form" action="addNewUserConn.php" method="POST">
	<div class="col-lg-6">
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        ...
                                        <div class="row form-group">
                                            <div class="col-8">
                                                <div class="form-group">
                                                    ...
                                                    <select name="shift1" id="shift1" class="form-control">
                                            ...
                                            <div class="col-8">
                                                <div class="form-group">
                                                    ...
                                                    <select name="user_type1" id="user_type1" class="form-control">
                                                        <option value="0">Please select</option>
										...
										<table>
				<tr><button type="submit" name = "submit1" class="btn btn-primary btn-sm"> Add
					</button> &nbsp;
				</tr></form>
				<tr> <form name="form2" action="userAdmin.php" method="POST">
                  <button onclick="history.go(-1);" class="btn btn-primary btn-sm"> Back
					</button> &nbsp;
				</form></tr></div></table>
