...
if(isset($_POST['search'])){
	...
	$sql1 ="SELECT WorkWeek,sum(ERAQtyName) as 'unit', sum(QtyDefect)as 'reject' FROM dbo.FrontEndView WHERE Year like '%$searchq%' AND WorkWeek BETWEEN '$searchq1' AND '$searchq2' and Day = 'Saturday' group by WorkWeek order by WorkWeek";

$stmt1 = sqlsrv_query( $conn, $sql1 );

	$sql2 ="SELECT WorkWeek,sum(ERAQtyName) as 'unit', sum(QtyDefect)as 'reject' FROM dbo.FrontEndView WHERE Year like '%$searchq%' AND WorkWeek BETWEEN '$searchq1' AND '$searchq2' and Day = 'Sunday' group by WorkWeek order by WorkWeek";

$stmt2 = sqlsrv_query( $conn, $sql2 );

	$sql3 ="SELECT WorkWeek,sum(ERAQtyName) as 'unit', sum(QtyDefect)as 'reject' FROM dbo.FrontEndView WHERE Year like '%$searchq%' AND WorkWeek BETWEEN '$searchq1' AND '$searchq2' and Day = 'Monday' group by WorkWeek order by WorkWeek";

$stmt3 = sqlsrv_query( $conn, $sql3 );

	$sql4 ="SELECT WorkWeek,sum(ERAQtyName) as 'unit', sum(QtyDefect)as 'reject' FROM dbo.FrontEndView WHERE Year like '%$searchq%' AND WorkWeek BETWEEN '$searchq1' AND '$searchq2' and Day = 'Tuesday' group by WorkWeek order by WorkWeek ";

$stmt4 = sqlsrv_query( $conn, $sql4 );

	$sql5 ="SELECT WorkWeek,sum(ERAQtyName) as 'unit', sum(QtyDefect)as 'reject' FROM dbo.FrontEndView WHERE Year like '%$searchq%' AND WorkWeek BETWEEN '$searchq1' AND '$searchq2' and Day = 'Wednesday' group by WorkWeek order by WorkWeek";

$stmt5 = sqlsrv_query( $conn, $sql5 );

	$sql6 ="SELECT WorkWeek,sum(ERAQtyName) as 'unit', sum(QtyDefect)as 'reject' FROM dbo.FrontEndView WHERE Year like '%$searchq%' AND WorkWeek BETWEEN '$searchq1' AND '$searchq2' and Day = 'Thursday' group by WorkWeek order by WorkWeek";

$stmt6 = sqlsrv_query( $conn, $sql6 );

	$sql7 ="SELECT WorkWeek,sum(ERAQtyName) as 'unit', sum(QtyDefect)as 'reject' FROM dbo.FrontEndView WHERE Year like '%$searchq%' AND WorkWeek BETWEEN '$searchq1' AND '$searchq2' and Day = 'Friday' group by WorkWeek order by WorkWeek";

$stmt7 = sqlsrv_query( $conn, $sql7 );

	$sql8 ="SELECT WorkWeek, sum(ERAQtyName) as 'totalunit', sum(QtyDefect)as 'totalreject',CAST(ROUND((convert(decimal,((sum(QtyDefect ) *1000000))))/(sum(ERAQtyName)), 2) AS NUMERIC(20,2)) as result FROM dbo.FrontEndView WHERE Year like '%$searchq%' AND WorkWeek BETWEEN '$searchq1' AND '$searchq2' group by WorkWeek order by WorkWeek";
...
?>
 ...
 <tr bgcolor="#73C6B6" >
  ...
  <tr>
    ...
    <td colspan='7' bgcolor="#fff"><center><?php echo 'PPM Formula = ( '.$row8['totalreject'].'*1000000) / '.$row8['totalunit'].'  '  ;?></center></td>
...
<?php  
 ...
 if(isset($_POST['search'])){
	...
	$searchq1 = $_POST['search1'];
	$searchq2 = $_POST['search2'];
	$sql ="SELECT WorkWeek,CAST(ROUND((convert(decimal,((sum(QtyDefect ) *1000000))))/(sum(ERAQtyName)), 2) AS NUMERIC(20,2)) as result FROM dbo.FrontEndView WHERE Year like '%$searchq%' AND WorkWeek BETWEEN '$searchq1' AND '$searchq2' group by WorkWeek order by WorkWeek";
...
<h2>FRONT END PPM TREND CHART</h2>
