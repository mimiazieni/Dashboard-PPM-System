                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">ERA Failed</h2>
                                </div>
                            </div>
                        </div>
...
?>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><?php echo $show['InternalName']."<br />" ;?></td>
                                            </tr><?php
}
?>
	<?php
...
$sql ="select * 
from dbo.ERAView  
WHERE WorkWeek = '$workWeek' AND Year = $currentYear AND Day = '$currentDay' AND ExternalName IS NOT NULL  ";
...
?>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><?php echo $show['WorkWeek']."<br />" ;?></td>
                                                <td><?php echo $show['Phase']."<br />" ;?></td>
                                                <td><?php echo $show['ExternalName']."<br />" ;?></td>
                                            </tr><?php
}
?>
