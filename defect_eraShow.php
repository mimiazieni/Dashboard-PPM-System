...
if(isset($_POST['search'])){
	...
	$sql ="SELECT  WorkWeek,InternalName, ExternalName, sum(QtyDefect) as count FROM dbo.ERAView WHERE Year like '$searchq' AND WorkWeek BETWEEN '$searchq1' AND '$searchq2' and QtyDefect > 0 and ExternalName is not null  group by WorkWeek,InternalName,ExternalName  order by WorkWeek";
...
?>
  ...
  <tr> 
     <td bgcolor="#fff"><?php echo $row['WorkWeek']."<br />" ;?></td>
	  <td bgcolor="#fff"><?php echo $row['ExternalName']."<br />" ;?></td>
...
if(isset($_POST['search'])){
	...
	$searchq1 = $_POST['search1'];
	$searchq2 = $_POST['search2'];
	$sql1 ="SELECT WorkWeek,sum(QtyDefect) as total1,sum(ERAQtyName) as tambah, CAST(ROUND((convert(decimal,((sum(QtyDefect ) *1000000))))/(sum(ERAQtyName)), 2) AS NUMERIC(20,2)) as result FROM dbo.ERAView WHERE Year like '%$searchq%' AND WorkWeek BETWEEN '$searchq1' AND '$searchq2' group by WorkWeek order by WorkWeek";
	
	$stmt1 = sqlsrv_query( $conn, $sql1 );
	
$sql11 ="SELECT WorkWeek,sum(QtyDefect) as total1 FROM dbo.ERAView WHERE Year like '%$searchq%' AND WorkWeek BETWEEN '$searchq1' AND '$searchq2' and ExternalName is not null group by WorkWeek order by WorkWeek";
...
if(isset($_POST['search'])){
	...
	$searchq1 = $_POST['search1'];
	$searchq2 = $_POST['search2'];
	$sql2 ="SELECT  WorkWeek,InternalName, ExternalName, sum(QtyDefect) as count ,Phase,Machine, Package,LotNo FROM dbo.ERAView WHERE Year like '$searchq' AND WorkWeek BETWEEN '$searchq1' AND '$searchq2' and QtyDefect > 0 and ExternalName is not null group by WorkWeek,InternalName,ExternalName,LotNo,Phase,Machine, Package order by WorkWeek";
...
<tbody>
  <tr> 
	...
	<td bgcolor="#fff"><?php echo $row2['LotNo']."<br />" ;?></td> 
	  <td bgcolor="#fff"><?php echo $row2['ExternalName']."<br />" ;?></td>
