                                ...
                                <div class="user-data m-b-30">
                                 ...
                                 <form action="addNewUser.php" method="POST">
									 <button class="au-btn au-btn-icon au-btn--green au-btn--small">
                                            <i class="zmdi zmdi-plus"></i>add user</button><br><br></form> 
                                    <div class="table-responsive table-data">
                                        <table border ='1' align="center" class="table">
                                            <thead>
                                                <tr align="center">
                                                    <th bgcolor="#A9DFBF  ">USERNAME</th>
                                                    <th bgcolor="#A9DFBF  ">NAME</th>
													<th bgcolor="#A9DFBF  ">TYPE</th>
													<th bgcolor="#A9DFBF  ">SHIFT</th>
...
?>	
                                            <tbody>
                                                <tr>
                                                    <td><a><?php echo $row["username"];?></a></td>
                                                    <td><a><?php echo $row["name"];?></a></td>
                                                    <td><a><?php echo $row["user_type"];?></a></td>
                                                    <td><a><?php echo $row["shift"];?></a></td>
													<td align="center"><a href="updateUser.php?id=".<?php $row["username"]?>."><i><img src="update.png"></i><br></a>&nbsp;<a href="deleteUser.php?id=".<?php $row['username']?>."><i><img src="img_cancel.png" style="width:25px;height:25px"></i><br></a></td>
