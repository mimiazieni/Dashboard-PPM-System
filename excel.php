...
from dbo.OQAVM 
WHERE WorkWeek = '$workWeek' AND Year = $currentYear AND Day = '$currentDay' GROUP BY Year)AS RESULT1,
(select count(*) 
from dbo.FrontEnd 
WHERE WorkWeek = '$workWeek' AND Year = $currentYear AND Day = '$currentDay' GROUP BY Year)AS RESULT2,
(select count(*) 
from dbo.ERA 
WHERE WorkWeek = '$workWeek' AND Year = $currentYear AND Day = '$currentDay' GROUP BY Year)AS RESULT3,
(select count(*) 
from dbo.BEXRAY 
WHERE WorkWeek = '$workWeek' AND Year = $currentYear AND Day = '$currentDay' GROUP BY Year)AS RESULT4";
