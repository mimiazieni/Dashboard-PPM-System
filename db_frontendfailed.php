                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">FRONT END FAIL</h2>
                                </div>
                            </div>
                        </div>
...
$sql ="select * from dbo.FrontEndView WHERE WorkWeek = '$workWeek' AND Year = $currentYear AND Day = '$currentDay' AND [Defect Mode] is not null";
