...
$sql ="select * from dbo.ERAView WHERE WorkWeek = '$workWeek' AND Year = $currentYear AND Day = '$currentDay' AND InternalName is null and ExternalName is null ";
