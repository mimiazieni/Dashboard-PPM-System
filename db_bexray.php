                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">BE XRAY PASS</h2>
                                </div>
                            </div>
                        </div>
...
$sql ="select * from dbo.BEXRAYView WHERE WorkWeek = '$workWeek' AND Year = $currentYear AND Day = '$currentDay' and [Defect Mode] is null ";
