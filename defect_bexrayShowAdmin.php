...
if(isset($_POST['search'])){
	...
	$searchq1 = $_POST['search1'];
	$searchq2 = $_POST['search2'];
	$sql2 ="SELECT [Defect Mode], WorkWeek, sum(QtyDefect) as count ,Phase,Machine, Package FROM dbo.BEXRAYView WHERE Year like '$searchq' AND WorkWeek BETWEEN '$searchq1' AND '$searchq2' and QtyDefect > 0 and [Defect Mode] is not null group by WorkWeek,[Defect Mode],Phase,Machine, Package order by WorkWeek,[Defect Mode]";
